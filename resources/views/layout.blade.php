...
<html lang="en">
  ...
  <body id="page-top">
    <nav class="navbar navbar-expand navbar-light bg-white static-top">
      <a class="navbar-brand mr-1" href="{{url('admin/dashboard')}}">WLBB</a>
    ...
    <div id="wrapper">
      <!-- Sidebar -->
      <ul class="sidebar navbar-nav bg-white">
        ...
        <!-- Comments -->
        <li class="nav-item">
          <a class="nav-link text-dark" href="{{url('admin/comment')}}">
        ...
        <!-- Users -->
        <li class="nav-item">
          <a class="nav-link text-dark" href="{{url('admin/user')}}">
        ...
        <!-- Settings -->
        <li class="nav-item">
          <a class="nav-link text-dark" href="{{url('admin/setting')}}">
        ...
        <footer class="sticky-footer bg-white">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>SMU PCWEB 7 | Ding Jen Han</span>
            </div>
          </div>
