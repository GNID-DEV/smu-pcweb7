...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-white">
      ...
      {{-- WLBB Logo --}}
		  <a class="navbar-brand" href="{{url('/')}}"><img src="{{asset('imgs')}}/wlbb_logo.svg" height="80"></a>
		  ...
		  <div class="collapse navbar-collapse" id="navbarNav">
		    <ul class="navbar-nav ml-auto">
		      <li class="nav-item active">
		        <a class="nav-link" href="{{url('/')}}">Lobang</a>
		      </li>
		      <li class="nav-item">
		      ...
		      <li class="nav-item">
		        <a class="nav-link btn btn-sm btn-danger text-white" href="{{url('register')}}">Register</a>
		      </li>
		      @else
		      <li class="nav-item">
		      ...
		      <li class="nav-item">
		        <a class="nav-link btn btn-sm btn-dark text-white" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" href="{{url('logout')}}">Logout</a>
		      </li>
